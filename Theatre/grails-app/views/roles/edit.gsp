...
<html>
    ...
    <body>
        ...
        <div id="edit-roles" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.roles}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.roles}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.roles}" method="PUT">
                <g:hiddenField name="version" value="${this.roles?.version}" />
                <fieldset class="form">
                    <f:all bean="roles"/>
                </fieldset>
