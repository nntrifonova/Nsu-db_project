...
<html>
    ...
    <body>
        ...
        <div id="show-roles" class="content scaffold-show" role="main">
            ...
            <f:display bean="roles" />
            <g:form resource="${this.roles}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.roles}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
